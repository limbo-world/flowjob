...
//     * 生成更新计划 JobDAG
//     */
//    public static DAG<JobInfo> convertJob(List<JobParam> jobParams) {
//        return new DAG<>(convertJobs(jobParams));
//    }
//
//
//    public static List<JobInfo> convertJobs(List<JobParam> jobParams) {
...
//     * 生成单个作业
//     */
//    public static JobInfo convertJob(JobParam param) {
