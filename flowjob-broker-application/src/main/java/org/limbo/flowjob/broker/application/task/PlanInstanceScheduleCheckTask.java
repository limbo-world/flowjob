...
@Slf4j
@Component
public class PlanInstanceScheduleCheckTask extends FixDelayMetaTask {
    ...
    public PlanInstanceScheduleCheckTask(MetaTaskScheduler scheduler,
                                         @Lazy Broker broker,
    ...
    protected void executeTask() {
        ...
        for (PlanInstanceEntity entity : list) {
            metaTaskScheduler.schedule(metaTaskConverter.toPlanInstanceScheduleTask(entity));
        }
    }
